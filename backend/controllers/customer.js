...
exports.register = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    console.log('Customer Created:', { id: customer._id, email: customer.email, isVerified: customer.isVerified });

    // Verify the customer was actually saved to database
    const savedCustomer = await Customer.findById(customer._id);
    console.log('Saved customer verification:', savedCustomer ? { id: savedCustomer._id, email: savedCustomer.email, isVerified: savedCustomer.isVerified } : 'Customer not found in database');
...
exports.login = asyncHandler(async (req, res, next) => {
  ...
  console.log('Sanitized email for login:', sanitizedEmail);
