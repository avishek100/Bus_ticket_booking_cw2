...
import { FaArrowLeft, FaArrowRight, FaChevronDown, FaChevronRight, FaClipboardList, FaCog, FaHome, FaListAlt, FaPlusCircle, FaTags, FaUser, FaUtensils } from 'react-icons/fa';
