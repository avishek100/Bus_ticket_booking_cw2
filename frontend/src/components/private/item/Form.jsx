        ...
        <div className="p-3 bg-gray-100 min-h-screen">
            <div className="p-6 bg-green-50 rounded-lg shadow-md hover:bg-green-100 transition">
                ...
                <h2 className="text-xl font-medium flex items-center mb-4 text-[#00bf63]">
                    <FaPlus className="mr-2 text-[#00bf63]" /> Add New Item
                </h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#00bf63]"
                    ...
                    <div className="flex justify-end">
                        <button
                            type="submit"
                            className="bg-[#00bf63] text-white py-2 px-6 rounded-lg hover:bg-[#009f4e] transition disabled:bg-gray-400"
                            disabled={mutation.isLoading || isCsrfLoading}
                        >
                            {mutation.isLoading ? 'Adding...' : isCsrfLoading ? 'Loading...' : 'Add Item'}
                        </button>
                    </div>
                </form>
            </div>
