    ...
    return (
        <>
            ...
            <div className="max-w-7xl bg-gray-300  mx-auto p-6">
                {/* Title */}
                <h2 className="text-3xl font-bold text-center text-black mb-8">Contact QuickBites</h2>
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <span className="text-gray-700">support@quickbites.com</span>
                            </div>
                            <div className="flex items-center space-x-4">
                                <FaMapMarkerAlt className="text-[#00bf63]" />
                                <span className="text-gray-700">123 QuickBites Street, Food City, Country</span>
                            </div>
                        </div>
