            ...
            <div className="max-w-4xl mx-auto p-6 bg-white mt-10">
                ...
                <div className="space-y-6 text-gray-700">
                    <section>
                        ...
                        <p>
                            Welcome to <strong>QuickBites</strong>. By accessing and using our services, you agree to comply
                    ...
                    <section>
                        ...
                        <p>To use QuickBites, you must:</p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5">
                            <li>Orders placed through QuickBites are subject to availability.</li>
                    ...
                    <section>
                        ...
                        <p>
                            QuickBites is not liable for any direct, indirect, incidental, or consequential damages
